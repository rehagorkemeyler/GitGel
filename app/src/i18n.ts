...
const tr = {
  ...
  saturday: 'Cumartesi',
  sunday: 'Pazar',
  scheduleNote: 'İlk ve son sefer ilk duraktan kalkış saatidir. Durağa dokununca o durağa sonraki varışları görürsün. Tarifeye göre.',
  modeMetro: 'Metro',
  ...
  nextArrivals: 'Sonraki seferler',
  now: 'şimdi',
  scheduledNote: 'Süreler tarifeye göre.',
  allNight: 'Gece boyunca',
  arriving: 'geliyor',
  trainScheduledNote: 'Bu tren konumu canlı değil; tarifeden hesaplandı.',
  pullForStops: 'Durakları ve varış saatlerini görmek için yukarı kaydır.',
...
const en: Record<StringKey, string> = {
  ...
  saturday: 'Saturday',
  sunday: 'Sunday',
  scheduleNote: 'First and last trips leave the first stop at these times. Tap a stop for its next arrivals. Scheduled.',
  modeMetro: 'Metro',
  ...
  nextArrivals: 'Next departures',
  now: 'now',
  scheduledNote: 'Times are scheduled.',
  allNight: 'All night',
  arriving: 'arriving',
  trainScheduledNote: 'This train position is not live; it is computed from the timetable.',
  pullForStops: 'Pull up for stops and arrival times.',
